        ...
        <div class="table-responsive">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <form action="add_category.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-bottom:5px; margin-top: 10px;">Add Category</button>
                    <input type="text"  class="form-control" id="categoryName" name="categoryName"
                            placeholder="Category Name" required>
                </form>
                <form method="GET" action="account_user.php">
                    <button type="submit" name="goback" class="btn btn-danger ml-auto" style="margin-bottom:40px;">Go back</button>
                </form>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#confirmDeleteBtn').click(function () {
                ...
                window.location.href = "delete_category.php?deleteid=" + deleteId;
            });
